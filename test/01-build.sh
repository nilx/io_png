...
# rgb->gray,f32  min 18.509 max 246.183 mean 116.768 std 49.417
# rgb->gray,u8:  min 19.000 max 246.000 mean 116.768 std 49.419
...
_test_mmms() {
    ...
    test "53efcdd8df4888e6f1b37d76ea363828  $TEMPFILE" \
	= "$(md5sum $TEMPFILE)"
    rm -f $TEMPFILE
}
